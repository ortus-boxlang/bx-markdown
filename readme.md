...
* `markdown()`
* `HtmlToMarkdown()`
* `markdownRegisterExtension()`
* `markdownUnregisterExtension()`
...
```js
markdownRegisterExtension( extension )
```
...
```js
markdownUnregisterExtension( extension )
```

**Arguments:**

* `extension` - The same extension instance passed to `markdownRegisterExtension()`.
