...
@BoxBIF
public class HtmlToMarkdown extends BIF {
	...
	public HtmlToMarkdown() {
		...
		this.declaredArguments = new Argument[] {
		    new Argument( true, Argument.STRING, KeyDictionary.html, Set.of( Validator.REQUIRED ) )
		};
	}
	 ...
	 *
	 * @argument.markdown The markdown string to be converted.
	 *
	 * @return The HTML string.
	 */
	public String _invoke( IBoxContext context, ArgumentsScope arguments ) {
		return this.markdownService.toMarkdown( arguments.getAsString( KeyDictionary.html ) );
	}
